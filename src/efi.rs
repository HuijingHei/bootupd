...
impl Component for Efi {
    ...
    fn generate_update_metadata(&self, sysroot_path: &str) -> Result<ContentMetadata> {
        ...
        let meta = get_update_metadata_from_usr(sysroot_path)?;
...
fn get_update_metadata_from_usr(sysroot_path: &str) -> Result<ContentMetadata> {
    let sysroot_path = Path::new(sysroot_path);
